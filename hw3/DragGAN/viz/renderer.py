...
def add_watermark_np(input_image_array, watermark_text="AI Generated"):
    ...
    temp_x,temp_y,text_width, text_height = font.getbbox(watermark_text)
    ...
    def _render_drag_impl(self, res,
        ...
        **kwargs
        ...
        if len(self.points)<0:
            print(len(points))
            img_temp = img[0] * (10 ** (img_scale_db / 20))
            img_temp = (img_temp * 127.5 + 128).clamp(0, 255).to(torch.uint8).permute(1, 2, 0)
            img_np = img_temp.cpu().numpy()
            ...
            predictor = dlib.shape_predictor(
                'C:\\Users\\34263\\Desktop\\DIP\\hw3\\DragGAN-main\\shape_predictor_68_face_landmarks.dat'
            )
