...
class DragWidget:
    ...
    def add_point(self, click, x, y):
        if click:
            image1 = cv2.imread('C:\\Users\\34263\\Desktop\\DIP\\hw3\\DragGAN-main\\_screenshots\\00000.png')
            detector = dlib.get_frontal_face_detector()
            predictor = dlib.shape_predictor(
                'C:\\Users\\34263\\Desktop\\DIP\\hw3\\DragGAN-main\\shape_predictor_68_face_landmarks.dat'
            )
            faces = detector(image1)
            ...
            if len(faces) == 0:
                ...
                for i, face in enumerate(faces):
                    ...
                    landmarks = predictor(image1, face)
                    for n in range(68):
